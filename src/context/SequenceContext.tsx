...
export function SequenceProvider({ children }: { children: ReactNode }) {
  const [availableMoves, setAvailableMoves] = useState<Move[]>([
    { id: 1, name: "Shoot", duration: 3, selected: false },
    { id: 2, name: "Block", duration: 2, selected: false },
    { id: 3, name: "Sprawl", duration: 3, selected: false },
    { id: 4, name: "Double Leg", duration: 4, selected: false },
  ...
  useEffect(() => {
    ...
    intervalIdRef.current = setTimeout(() => {
      console.log(`Time's up for ${currentMove.name}, picking next move`);
